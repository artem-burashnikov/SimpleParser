...
[<assembly: AssemblyTitleAttribute("SimpleParser")>]
[<assembly: AssemblyProductAttribute("SimpleParser")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "SimpleParser"
    let [<Literal>] AssemblyProduct = "SimpleParser"
